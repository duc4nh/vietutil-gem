...
describe Vietutil do
  it 'has a version number' do
    expect(Vietutil::VERSION).not_to be nil
  end

  it 'convert unicode to ascii' do
    text = Vietutil.convert_unicode("Đây là một đoạn tiếng việt có dấu  Theo chương trình, Thường trực Ban Bí thư Lê Hồng Anh sẽ đọc báo cáo kiểm điểm sự lãnh đạo, chỉ đạo của Ban chấp hành trung ương Đảng khoá XI. Chiều nay, đại biểu họp đoàn, thảo luận các văn kiện Đại hội.
